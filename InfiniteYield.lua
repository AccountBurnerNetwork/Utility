...
CMDs[#CMDs + 1] = {NAME = 'remotespy1 / rspy1', DESC = 'Opens Simple Spy V3'}
CMDs[#CMDs + 1] = {NAME = 'remotespy2 / rspy2', DESC = 'Opens Simple Spy V3'}
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/AccountBurnerNetwork/Utility/refs/heads/main/InfiniteYield.lua'))()")
	end
end)
...
addcmd('remotespy1',{'rspy1'},function(args, speaker)
	notify("Loading",'Hold on a sec')
...
addcmd('remotespy2',{'rspy2'},function(args, speaker)
	notify("Loading",'Hold on a sec')
	-- Full credit to exx, creator of SimpleSpy
	-- also thanks to Amity for fixing
